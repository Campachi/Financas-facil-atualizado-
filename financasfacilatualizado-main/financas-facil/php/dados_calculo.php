...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO finance_calculations (user_id, salario, despesas, outras_despesas, agua, energia, mercado, prestacoes_veiculares, gas, condominio, internet, dividas, percapita, data) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("idddddddddddis", $user_id, $salario, $despesas, $outras_despesas, $agua, $energia, $mercado, $prestacoes_veiculares, $gas, $condominio, $internet, $dividas, $percapita, $data);
