...
<body>
    <header>
        <nav class="navbar">
            ...
            <div class="search-container">
                <input type="text" placeholder="Buscar..." id="searchInput" onkeyup="filterTable()">
    ...
    <script>
        function filterTable() {
            ...
            // Limpar o destaque anterior
            rows.forEach(row => {
                const cells = row.querySelectorAll("td");
                cells.forEach(cell => {
                    cell.innerHTML = cell.textContent; // Reseta o conteúdo para o texto original
                });
            });
            ...
            if (searchInput) {
                rows.forEach(row => {
                    ...
                    // Exibir ou ocultar a linha com base na pesquisa
                    row.style.display = found ? "" : "none";
                });
            } else {
                // Se não houver texto de pesquisa, mostrar todas as linhas
